...
var $multiply2 = (0, _jquery.default)("#multiply2");
...
var $tabList = (0, _jquery.default)("#app2 .tabList");
var $contentList = (0, _jquery.default)("#app2 .contentList");
$tabList.on("click", "li", function (e) {
  var $li = (0, _jquery.default)(e.currentTarget);
  var index = $li.index();
  $li.addClass("selector").siblings().removeClass("selector");
  $contentList.children().eq(index).addClass("active").siblings().removeClass("active");
});
...
var $square = (0, _jquery.default)("#app3 .square").on("click", function () {
